...
/**
 * Lightweight baseline that keeps all features available,
 * while reducing default resource usage.
 * Any value here can still be overridden by user config.
 */
export const LIGHTWEIGHT_CONNECTION_CONFIG: Partial<SocketConfig> = {
